...
<div class="bg-gradient-to-t from-[#c2c9fb] to-[#eea6af] min-h-screen flex items-center justify-center">
    <div class="container mx-auto flex flex-col items-center justify-center h-full gap-10">
        <div class="bg-white p-10 rounded-lg shadow-lg max-w-2xl w-full overflow-auto mb-5 mt-5">
            <h1 class="text-3xl font-bold mb-6 text-center text-[#eea6af]">Ajouter une Production</h1>
            ...
            <form class="space-y-6" action="<?= WEBROOT ?>" method="post">
                <div class="flex gap-4">
                    ...
                    <div class="w-1/4">
                        ...
                        <input name="qteProd" id="inputQuantite" class="mt-1 block w-full border border-[#c2c9fb] rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-[#a6c1ee] focus:border-[#a6c1ee] sm:text-sm <?= add_class_invalid("qteProd") ?>" placeholder="Quantité">
                ...
                <div class="mt-4">
                    ...
                    <div id="errorQuantite" class="text-red-500 text-sm mt-1"><?= $erros["observation"] ?? "" ?></div>
                </div>

                <div class="flex justify-end mt-4">
                    <input type="hidden" name="action" value="add-articleProd">
                ...
                <div class="flex gap-4 w-full mt-4">
                    ...
                    <button type="button" class="bg-[#eea6af] text-white w-full px-5 py-2 mb-1 rounded-full hover:bg-[#c2c9fb] transition duration-300" name="" id="addArticle"><a href="<?= WEBROOT ?>?action=add-prod&controller=prod">Enregistrer</a></button>
                </div>
            </form>
        </div>
    </div>
