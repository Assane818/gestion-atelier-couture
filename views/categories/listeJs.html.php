...
<div class="flex items-center justify-center h-[calc(100vh-5rem)]">
    <div class="container mx-auto flex flex-col items-center justify-center gap-10">
        <div class="bg-white p-10 rounded-lg shadow-lg max-w-2xl w-full overflow-hidden mb-5 mt-5">
            <h1 class="text-2xl font-bold mb-6">Gestion des Categories</h1>
            <form class="mb-6" action="<?=WEBROOT?>" method="post">
                <div class="flex items-center">
                    <input name="nomCategorie" id="inputTypeCategorie" class="block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-[#a6c1ee] focus:border-[#a6c1ee] sm:text-sm <?= add_class_invalid("nomCategorie")?>" placeholder="Nom du nouveau type">
